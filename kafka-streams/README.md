...
* [ProbabilisticCountingScalaIntegrationTest](src/test/java/io/confluent/examples/streams/algebird/ProbabilisticCountingScalaIntegrationTest.scala)
  -- demonstrates how to probabilistically count items in an input stream using a custom state store implementation that
  is backed by a [Count-Min Sketch](https://en.wikipedia.org/wiki/Count%E2%80%93min_sketch) data structure (with the CMS
